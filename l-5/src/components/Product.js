...
import {add,remove} from "../redux/Slices/CardSlics"
const Product = ({post}) => {
    ...
    return (
        ...
        gap-3 p-4 mt-10 ml-5 rounded-xl outline">
            ...
            <div>
                <p className="w-40 text-gray-400 font-semibold text-[10px] text-left">{post.description.split(" ").slice(0,10).join(" ")+"...."}</p>
            </div>
